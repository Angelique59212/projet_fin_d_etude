<!--<img id="dys" src="/assets/img/les_troubles_dys.jpg" alt="les troubles dys">-->
<p id="def-dys">
...
<div class="container-dys">
    ...
    <!--Dyspraxie -->
    <div class="card">
        <img class="card-img-top w-20" src="/assets/img/dyspraxie/dyspraxie.jpg" alt="enfant dyspraxique">
        <div class="card-body">
            <h2 class="card-title fw-bold">Dyspraxie</h2>
            <p class="card-text">
                La dyspraxie est un trouble développemental de la coordination qui inclue également certains troubles
                de l'écriture.
                Elle occasionne des difficultés dans les gestes de coordination, les jeux à motricité fine,
